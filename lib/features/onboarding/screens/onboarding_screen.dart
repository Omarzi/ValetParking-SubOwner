        ...
        children: [
          ...
          SizedBox(
            ...
            child: Column(
              ...
              children: [
                MainButtonWidget(
                  centerWidgetInButton: Text(currentIndex == VConstants.onBoardingImage.length-1 ? 'Continue' : 'Next', style: VStyles.bodyLargeBold(context).copyWith(color: VColors.whiteColor)),
                  onTap: () {
                ...
                MainButtonWidget(
                  centerWidgetInButton: Text('Skip', style: VStyles.bodyLargeBold(context).copyWith(color: VColors.primaryColor500)),
                  onTap: () {
                    context.pushNamed(VRoutesName.loginAccountRoute);
                  },
                  margin: EdgeInsets.zero,
