...
class _EditProfileFormWidgetState extends State<EditProfileFormWidget> {
  ...
  void initState() {
    ...
    fullNameOfCarFocusNode.addListener(() => setState(() => isFullNameOfCarFieldFocused = fullNameOfCarFocusNode.hasFocus));
    numberOfCarFocusNode.addListener(() => setState(() => isNumberOfCarFieldFocused = numberOfCarFocusNode.hasFocus));
    ...
    return Column(
      ...
      children: [
        ...
        TextFormFieldWidget(
          ...
          hintColor: isFullNameFieldFocused ? VColors.primaryColor500 : VColors.greyScale900,
          prefixIcon: Icon(
          ...
          fillColor: isFullNameFieldFocused ? VColors.purpleTransparent.withOpacity(.08) : VColors.greyScale50,
          borderSide: isFullNameFieldFocused ? BorderSide(color: VColors.primaryColor500) : BorderSide.none,
          obscureText: false,
          isEdit: true,
        ),
        ...
        TextFormFieldWidget(
          ...
          hintColor: isEmailFieldFocused ? VColors.primaryColor500 : VColors.greyScale900,
          prefixIcon: SvgPicture.asset(VImages.email2Icon, fit: BoxFit.scaleDown, colorFilter: ColorFilter.mode(VColors.greyScale900, BlendMode.srcIn)),
          fillColor: isEmailFieldFocused ? VColors.purpleTransparent.withOpacity(.08) : VColors.greyScale50,
          borderSide: isEmailFieldFocused ? BorderSide(color: VColors.primaryColor500) : BorderSide.none,
          obscureText: false,
          isEdit: true,
        ),
        ...
        Align(
          ...
          child: MainButtonWidget(
            centerWidgetInButton: Text(AppLocalizations.of(context)!.translate('update')!, style: VStyles.bodyLargeBold(context).copyWith(color: VColors.whiteColor)),
            onTap: () {},
            margin: EdgeInsets.zero,
            buttonColor: fullNameController.text.isEmpty || addressController.text.isEmpty || dateOfBirthController.text.isEmpty || addressController.text.isEmpty ? VColors.disabledButton : VColors.primaryColor500,
