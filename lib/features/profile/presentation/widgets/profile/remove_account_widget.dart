    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(width: double.infinity, height: VDeviceUtils.getScreenHeight(context) / 26, child: Text(AppLocalizations.of(context)!.translate('removeAccount')!, style: VStyles.h4Bold(context).copyWith(color: VColors.alertsAndStatusError), textAlign: TextAlign.center)),
            ...
            SizedBox(width: double.infinity, height: VDeviceUtils.getScreenHeight(context) / 26, child: Text(AppLocalizations.of(context)!.translate('areYouSureYouWantToRemove')!, style: VStyles.h5Bold(context).copyWith(color: VColors.greyScale800), textAlign: TextAlign.center)),
            ...
            SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SecondButtonWidget(bgColor: VColors.primaryColor500, widget: Text(AppLocalizations.of(context)!.translate('yesRemove')!, style: VStyles.bodyLargeBold(context).copyWith(color: VColors.whiteColor)), onTap: () {
