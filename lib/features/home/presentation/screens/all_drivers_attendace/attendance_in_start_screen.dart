...
class AttendanceInStartScreen extends StatefulWidget {
  const AttendanceInStartScreen({super.key});

  @override
  State<AttendanceInStartScreen> createState() =>
      _AttendanceInStartScreenState();
}

class _AttendanceInStartScreenState extends State<AttendanceInStartScreen> {
  ...
  void initState() {
    ...
    // HomeCubit.get(context).getAttendanceInStartFunction(createdAtGTE: DateTime.now().toString(), createdAtLTE: DateTime.now().toString());
    ...
    return Scaffold(
      ...
      body: BlocConsumer<HomeCubit, HomeState>(
        ...
        builder: (context, state) {
          ...
          var driverItem =
              getAttendanceInStartCubit.getAttendanceInStartResponseModel.data;
                  ...
                  driverItem == null
                      ...
                      : Column(
                          children: [
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        ...
                                        style:
                                            VStyles.bodyLargeSemiBold(context).copyWith(
                                          color: VColors.whiteColor,
                                        ),
                                      ),
                                    ),
                            ...
                            driverItem == [] || driverItem.isEmpty
                                ? Text('${AppLocalizations.of(context)!.translate('theAttendanceIsEmpty')}',
                                    style: VStyles.h4Bold(context))
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  GestureDetector(
                                                    ...
                                                    child: Text(
                                                      '${AppLocalizations.of(context)!.translate('garageLocation')}: ${driverItem[index].garage?.lat ?? 'No location latitude'} - ${driverItem[index].garage?.lng ?? 'No location long'}',
                                                      style: VStyles.bodyLargeSemiBold(context).copyWith(color: VColors.greyScale700),
                                                    ),
                                                  ),
                                                  SizedBox(height: 6.h),
                                                  ...
                                                  SizedBox(height: 6.h),
                                                  Text(
                                                    '${AppLocalizations.of(context)!.translate('garagePlaces')}: ${driverItem[index].garage?.active == true ? 'Have space' : 'Not have space'}',
                                                      style: VStyles.bodyLargeSemiBold(context).copyWith(color: VColors.greyScale700),
                                                  ),
                                                  SizedBox(height: 6.h),
                                                  Text(
                                                  ...
                                                  SizedBox(height: 6.h),
                                                  Text(
                                                    '${AppLocalizations.of(context)!.translate('startIn')}: ${driverItem[index].driver?.startIn ?? 'No start in driver'}',
                                                    style: VStyles.bodyLargeSemiBold(context).copyWith(color: VColors.greyScale700),
                                                  ),
                                                ],
                                              ),
